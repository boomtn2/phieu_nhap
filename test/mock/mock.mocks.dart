...
// in phieu_nhap/test/mock/mock.dart.
...
class MockCollectionReference<T extends Map<String, dynamic>> extends _i1.Mock
    implements _i4.CollectionReference<T> {
...
/// See the documentation for Mockito's code generation for more information.
// ignore: must_be_immutable
class MockDocumentReference<T extends Map<String, dynamic>> extends _i1.Mock
    implements _i4.DocumentReference<T> {
...
///
/// See the documentation for Mockito's code generation for more information.
class MockQuerySnapshot<T extends Map<String, dynamic>> extends _i1.Mock
...
///
/// See the documentation for Mockito's code generation for more information.
class MockQueryDocumentSnapshot<T extends Map<String, dynamic>> extends _i1.Mock
